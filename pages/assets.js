...
export default function Assets({posts}) {
  var indents = [];
        ...
        <main className={styles.main}>
            ...
            <div className="section">
                <div className="container">
                    <div className="wrap">
                        <h1 className="font-lg vert-margin-top">Assets</h1>
                        <h2 className="grey">2d, 3d, low poly, audios</h2>
...
export function getStaticProps() {
  ...
  }).filter(post => post.data.category == "asset")
